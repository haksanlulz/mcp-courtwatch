...
| `judge_lookup` | `name_last` and/or `name_first` (at least one), `limit` | Judges / people (`/people/`). Per person: id, assembled name, birth and death dates and place, gender, count of positions on file. One page of 20 max; `more_available` says whether more match. |
...
Counts as of 2026-09-14: 136 tests in 4 files (`npm test`), 2465 lines of app source and packaging scripts, 2116 lines of test source.
